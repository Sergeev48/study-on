...
//            $this->assertResponseRedirect();
//            $crawler = self::getClient()->request('GET', '/courses/' . $course->getId() . '/new/lesson');
//            $this->assertResponseRedirect();
//            $crawler = self::getClient()->request('POST', '/courses/' . $course->getId() . '/new/lesson');
//            $this->assertResponseRedirect();
//        }
...
//        $this->assertResponseRedirect();
//        $crawler = $client->followRedirect();
//        self::assertPageTitleContains('Курсы / StudyOn');
//    }
...
//                'user_registration_form[password][second]' => '12345678',
//                'user_registration_form[agreeTerms]' => true,
//                'user_registration_form[email]' => 'user1114@gmail.com',
//            ]
//        );
//        $client->submit($form);
//        $this->assertResponseRedirect();
...
//        $this->assertResponseOk();
//        self::assertSelectorExists('#email');
//        self::assertSelectorTextContains('#email', 'user1114@gmail.com');
//    }
}